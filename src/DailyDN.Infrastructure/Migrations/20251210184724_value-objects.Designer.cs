...
namespace DailyDN.Infrastructure.Migrations
{
    ...
    [Migration("20251210184724_value-objects")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DailyDN.Domain.Entities.User", b =>
                {
                    b.OwnsOne("DailyDN.Domain.ValueObjects.Email", "Email", b1 =>
                        {
                    ...
                    b.OwnsOne("DailyDN.Domain.ValueObjects.FullName", "FullName", b1 =>
                        {
                            b1.Property<int>("UserId")
                                .HasColumnType("int");
                    ...
                    b.OwnsOne("DailyDN.Domain.ValueObjects.PasswordHash", "PasswordHash", b1 =>
                        {
                            b1.Property<int>("UserId")
                                .HasColumnType("int");
                    ...
                    b.OwnsOne("DailyDN.Domain.ValueObjects.PhoneNumber", "PhoneNumber", b1 =>
                        {
                            b1.Property<int>("UserId")
                                .HasColumnType("int");
